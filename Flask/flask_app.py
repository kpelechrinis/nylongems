...
<html lang="en" style="height: 100%">
    <head>
        ...
        <link rel="stylesheet" href="/static/CACHE/css/f438f1304d1c.css" type="text/css" media="screen" />
        ...
        <script type="text/javascript">
            var Anywhere = {};
            Anywhere.urls = {};
            Anywhere.csrfToken = "dfgUSLj3mMItVFmCkaQkNFeQpkw1u0XbGD2cUjmYKxoLl4Z0n4PvToACfZOBVm2F";
        </script>
...
<li class="visible-xs"><a href="https://blog.pythonanywhere.com/" class="blog_link">Blog</a></li>
  ...
  <form class="form" action="" method="post"><input type='hidden' name='csrfmiddlewaretoken' value='dfgUSLj3mMItVFmCkaQkNFeQpkw1u0XbGD2cUjmYKxoLl4Z0n4PvToACfZOBVm2F' />
    <table>
